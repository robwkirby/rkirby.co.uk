<template>
    <form action="https://formspree.io/hello@rkirby.co.uk" method="POST" class="contact-form__form" @submit.prevent="submit">
        <div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-form__field contact-form__field--message">
                    ...
                    <div class="contact-form__error" v-if="!$v.message.minLength">Name must have at least {{$v.message.$params.minLength.min}} letters.</div>
                </div>
            </div>
        </div>
    ...
    methods: {
        submit() {
            ...
            if (this.$v.$invalid) {
                ...
                axios({
                    method: 'post',
                    url: 'https://formspree.io/hello@rkirby.co.uk',
                    data: bodyFormData,
